...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ImageViewHoder>{
    ...
    public ImageAdapter(Activity activity, List<AdBoardFile> adBoardFiles) {
    ...
    public ImageViewHoder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.image_item, null);
